...
const messages: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "scan.typeContract": "Smart Contract (Solidity)",
    "scan.typeRpc": "RPC Endpoint",
    "scan.typeWeb3": "Web3 Frontend",
  ...
  zh: {
    ...
    "scan.typeContract": "智能合约扫描（Solidity）",
    "scan.typeRpc": "RPC 节点扫描",
    "scan.typeWeb3": "Web3 前端扫描",
    "scan.path": "目标路径",
